...
| <a id="go_deps.gazelle_override-build_file_generation"></a>build_file_generation |  One of `"clean"` (default), `"update"`, `"off"`<br><br>Whether Gazelle should generate build files for the Go module.<br><br>In `"clean"` mode (default), Gazelle will ignore bazel files from the repository, and create new files.<br><br>In `"update"` mode, Gazelle will attempt to use and update the existing files in the repository.<br><br>In `"off"` mode, Gazelle will leave the BUILD files from the repository intact.   | String | optional |  `"clean"`  |
...
| <a id="go_deps.gazelle_default_attributes-build_file_generation"></a>build_file_generation |  One of `"clean"` (default), `"update"`, `"off"`<br><br>Whether Gazelle should generate build files for the Go module.<br><br>In `"clean"` mode (default), Gazelle will ignore bazel files from the repository, and create new files.<br><br>In `"update"` mode, Gazelle will attempt to use and update the existing files in the repository.<br><br>In `"off"` mode, Gazelle will leave the BUILD files from the repository intact.   | String | optional |  `"clean"`  |

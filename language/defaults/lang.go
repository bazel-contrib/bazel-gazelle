...
type defaultsExtension struct{}

var (
	_ language.Language  = (*defaultsExtension)(nil)
	_ config.Configurer  = (*defaultsExtension)(nil)
	_ language.Generator = (*defaultsExtension)(nil)
)

// NewV2 constructs a new language.Language modifying package() defaults.
func NewV2() language.Language {
	return &defaultsExtension{}
}

func (*defaultsExtension) Name() string {
	return _extName
}

// Kinds instructs gazelle to match any 'package' rule as BUILD files can only have one.
func (*defaultsExtension) Kinds() []rule.KindInfo {
...
func (*defaultsExtension) Generate(ctx context.Context, args language.GenerateArgs) (language.GenerateResult, error) {

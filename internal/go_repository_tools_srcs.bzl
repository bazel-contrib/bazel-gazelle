...
GO_REPOSITORY_TOOLS_SRCS = [
    ...
    Label("//cmd/generate_gazelle_binary_languages:BUILD"),
    Label("//cmd/generate_gazelle_binary_languages:main.go"),
    ...
    Label("//internal/workspace:BUILD.bazel"),
    ...
    Label("//language/defaults:BUILD.bazel"),
    Label("//language/defaults:config.go"),
    Label("//language/defaults:lang.go"),
    ...
    Label("//v2/cmd/gazelle/update:version.go"),
    ...
    Label("//v2/resolve:BUILD.bazel"),
    Label("//v2/resolve:config.go"),
    Label("//v2/resolve:index.go"),
    ...
    Label("//v2/rule:rule.go"),
    Label("//v2/rule:sort_labels.go"),
    Label("//v2/rule:types.go"),
    Label("//v2/rule:value.go"),
    Label("//v2/testtools:BUILD.bazel"),
    Label("//v2/testtools:config.go"),
    Label("//v2/testtools:files.go"),
    Label("//v2/walk:BUILD.bazel"),
    Label("//v2/walk:cache.go"),
    Label("//v2/walk:config.go"),
    Label("//v2/walk:dirinfo.go"),
    Label("//v2/walk:walk.go"),

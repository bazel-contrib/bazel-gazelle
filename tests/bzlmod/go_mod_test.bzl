...
def _use_spec_to_label_test_impl(ctx):
    ...
    asserts.equals(env, Label("@@org_example//go/foo/bar:go.mod"), use_spec_to_label("org_example", "./foo/bar", "go"))
    asserts.equals(env, Label("@@org_example//go:go.mod"), use_spec_to_label("org_example", ".", "go"))

...
TEST = r"""
{
  ...
  "modules": [
    {
      ...
      "tags": {
        "from_file": [
          {
            "go_work": "@@replace_version_work//:go.work"
          }
        ]
      }
    }
  ...
  "files": {
    "./replace_version_work/go.mod": "module example.com/replace_version_work\n\ngo 1.24.12\n\nrequire golang.org/x/mod v0.40.0 // indirect\n",
  ...
  "executions": {
    "main": {
      ...
      "go mod edit -json -- ./replace_version_work/go.mod": "{\n\t\"Module\": {\n\t\t\"Path\": \"example.com/replace_version_work\"\n\t},\n\t\"Go\": \"1.24.12\",\n\t\"Require\": [\n\t\t{\n\t\t\t\"Path\": \"golang.org/x/mod\",\n\t\t\t\"Version\": \"v0.40.0\",\n\t\t\t\"Indirect\": true\n\t\t}\n\t],\n\t\"Exclude\": null,\n\t\"Replace\": null,\n\t\"Retract\": null,\n\t\"Tool\": null,\n\t\"Ignore\": null\n}\n",
      "go work edit -json -- ./replace_version_work/go.work": "{\n\t\"Go\": \"1.24.12\",\n\t\"Use\": [\n\t\t{\n\t\t\t\"DiskPath\": \".\"\n\t\t}\n\t],\n\t\"Replace\": [\n\t\t{\n\t\t\t\"Old\": {\n\t\t\t\t\"Path\": \"golang.org/x/mod\"\n\t\t\t},\n\t\t\t\"New\": {\n\t\t\t\t\"Path\": \"golang.org/x/mod\",\n\t\t\t\t\"Version\": \"v0.39.0\"\n\t\t\t}\n\t\t}\n\t]\n}\n"
    }
  },
  "want": {
    "main": {
